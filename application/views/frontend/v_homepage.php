                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="title-box text-center">
                            ...
                            <p class="subtitle-a">A glimpse of what [Your Brand Name] offers.</p>
                            <div class="line-mf"></div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="title-box text-center">
                    ...
                    <p class="subtitle-a">At [Your Brand Name], we are committed to providing the highest quality products and a comfortable atmosphere for all our customers. Every visit tells a story, and we want to help you find yours.</p>
                    <div class="line-mf"></div>
                </div>
            </div>
        </div>
